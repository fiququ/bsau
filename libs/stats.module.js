var Stats = function () {
    ...
    // Adding the "CLICK TO SWAP MODE" text
    var infoText = document.createElement('div');
    infoText.style.cssText = 'position:relative;color:#fff;font-family:Arial, sans-serif;font-size:10px;padding:3px;margin:0 auto;';
